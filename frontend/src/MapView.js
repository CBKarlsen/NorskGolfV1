		...
		return (
			...
			>
				...
				<Skeleton
					...
					width={40}
					height={80}
					sx={{ position: "absolute", top: 20, left: 20, borderRadius: 1 }}
				/>
			</Box>
		);
	}
		...
		<>
			...
			>
				<MapController
					...
					closePopupTrigger={closeTrigger}
				/>
							...
							>
								<Box sx={{ textAlign: "center", p: 1 }}>
									...
									{isPlayed ? (
										...
										<Typography
											variant="body2"
											sx={{ color: "#757575", fontStyle: "italic", mb: 2 }}
										>
