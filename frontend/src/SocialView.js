...
function SocialView({ user }) {
	...
	const getRankDisplay = (index) => {
		...
		if (index === 2)
			return <EmojiEventsIcon sx={{ color: "#CD7F32", fontSize: 26 }} />;
		return (
			<Typography
				variant="h6"
				sx={{
			...
			>
				...
				>
					...
					<Typography variant="body1" color="textSecondary" sx={{ mb: 3 }}>
						Logg inn for å finne venner, sammenligne score og klatre på
						topplisten.
					</Typography>
										...
										>
											...
											<Box sx={{ display: "flex", gap: 1 }}>
												<IconButton
													size="small"
													onClick={() =>
														respondToRequest(req.friendshipId, "ACCEPT")
													}
													sx={{ color: "green", bgcolor: "#e8f5e9" }}
												>
												...
												<IconButton
													size="small"
													onClick={() =>
														respondToRequest(req.friendshipId, "REJECT")
													}
													sx={{ color: "red", bgcolor: "#ffebee" }}
												>
										...
										return (
											...
											>
												<ListItem sx={{ py: 2 }}>
													...
													<Box
														sx={{ textAlign: "right", display: "flex", gap: 3 }}
													>
														<Box>
															<Typography
																variant="h6"
